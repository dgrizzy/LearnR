...
```{r}
# When a file is in the folder above the folder your file is in, you can use ../ before the file name to get to it
titanic <- read.csv("../titanic.csv")

sum(titanic$Survived[titanic$Embarked == "Q"]) / nrow(titanic)
```
